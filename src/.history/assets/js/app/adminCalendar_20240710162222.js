            ...
            $scope.processDoctorUnavailability().then(dataDu => {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    select: function (arg) {
                        ...
                        var formattedDate = moment(now).format("DD/MM/YYYY");
                        var nowConvert=TimezoneService.convertToTimezone(formattedDate,defaultTimezone)
                        console.log("arg",arg);
                        console.log("nowConvert",nowConvert);
                        // now.setMinutes(now.getMinutes() - 10)
