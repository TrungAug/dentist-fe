app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.updateAppoinmentToDB = async (appointment, statusId, isDeleted, currentCondition, reExamination) => {
        ...
        var response = await $http.put(url + '/appointment-patient-record/' + appointment.appointmentPatientRecord.appointmentPatientRecordId, dataAppointmentPatientRecordRequest)

        var resp = await $http.put(url + '/appointment/'+appointment.appointment.appointmentId, dataAppointmentRequestJSON)

        var res = await $http.put(url + '/doctorUnavailability/'+appointment.doctorUnavailabilityId, dataDoctorUnavailabilityRequest)

        console.log("dataAppointmentRequestJSON", dataAppointmentRequestJSON)
        console.log("dataDoctorUnavailabilityRequest", dataDoctorUnavailabilityRequest)
        console.log("dataAppointmentPatientRecordRequest", dataAppointmentPatientRecordRequest)
        console.log("appointment updateAppoinmentToDB", appointment);
    }
    ...
    $scope.getDataAppointmentPatientRecordRequest = (appointment, isDeleted, currentCondition, reExamination) => {
        $scope.formAppointmentPatientRecordRequest = {
            patientId: appointment.appointment.patient.patientId,
            createAt: appointment.appointment.createAt,
