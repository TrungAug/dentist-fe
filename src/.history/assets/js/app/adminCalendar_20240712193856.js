...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initDataRequest = (isUpdate) => {
        ...
        console.log("formUpApp init", $scope.formUpApp);
        ...
        $scope.appointmentRequest = {
            ...
            appointmentType: fa.appointmentTypeId,
            doctorId: fa.doctorId,
            dentalStaffId: dentalStaff,
            appointmentStatus: fa.appointmentStatus,
            appointmentDate: TimezoneService.convertToTimezone(moment(fa.appointmentDate, "DD/MM/YYYY"), defaultTimezone),
            note: fa.notes,
            createAt: TimezoneService.convertToTimezone(moment(new Date()), defaultTimezone),
            isDeleted: false
        }
    ...
    $scope.showFormResult = (statusId) => {
        ...
        if (st.status.toLowerCase() === 'hoàn thành') {
