...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#appointmentStatus').on('change', function () {
            $timeout(function () {
                ...
                console.log("$scope.formUpApp.appointmentStatus",$scope.formUpApp.appointmentStatus);
    ...
    // Destroy Select2 instances when modal is hidden to avoid duplicate initialization
    $('#updateAppointment').on('hidden.bs.modal', function () {
