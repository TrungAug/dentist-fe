app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location, $timeout, $window, processSelect2Service, TimezoneService, $route) {
    ...
    // var fullCalendar2=new FullCalendar2.Calendar("")
    // console.log("fullCalendar2",fullCalendar2);
    ...
    $scope.initializeCalendarRegisterDoctorSchedule = () => {
        ...
        var calendar = new FullCalendar2.Calendar(calendarEl, {
            ...
            selectMirror: true,
            select: function (arg) {  
                var startDate= TimezoneService.convertToTimezone(arg.start,defaultTimezone) 
                var endDate=TimezoneService.convertToTimezone(arg.end,defaultTimezone)
