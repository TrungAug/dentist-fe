...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initializeCalendarAppointment = () => {
        ...
        const loadResourcesAndEvents = (currentDate, resourceId) => {
        ...
        const renderCalendar = () => {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                datesRender: function (info) {
                    ...
                    loadResourcesAndEvents(info.view.currentStart,info.resource.id);
                    var now = new Date();
                ...
                resourceRender: function (arg) {
                    //loadResourcesAndEvents($scope.fullCalendarDate, arg.resource.id)
                }
            });
