app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.isCheckTos = (tos,doctorId) => {
        ...
        return $scope.originalDU.some(oDu => {
            tos.checked=oDu.timeOfShift
            return oDu.timeOfShift.timeOfShiftId === timeOfShiftId&&oDu.appointment.doctor.doctorId ===doctorId
        })
