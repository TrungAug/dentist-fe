            ...
            $scope.processDoctorUnavailability().then(dataDu => {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventMouseEnter: function (arg) {
                        // Xử lý khi di chuột vào event
                        var tooltip = '<div class="tooltipevent" style="width:auto;height:auto;background:#F8F8F8;position:absolute;z-index:10001;padding:10px;border:1px solid #D4D4D4;">' +
                            '<p style="font-size:14px;color:#666;margin:0;">' + arg.event.title + '</p>' +
                            '</div>';
                        $("body").append(tooltip);
                    ...
                    eventMouseLeave: function () {
                        // Xử lý khi di chuột ra khỏi event
                        $(this).css('z-index', 8);
                        $('.tooltipevent').remove();
                    }
                });
