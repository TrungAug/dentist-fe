    ...
    $scope.initializeCalendarAppointment = () => {
        ...
        const loadResourcesAndEvents = (currentDate) => {
            $scope.processDSWithAppointmentStatus(currentDate).then(result => {
                ...
                loadDoctorUnavailability(resources, currentDate);
            });
        };
    
        const loadDoctorUnavailability = (resources, currentDate) => {
            $scope.processDoctorUnavailability(currentDate).then(dataDu => {
                eventArr = [];
                dataDu.forEach(du => {
        ...
        const renderCalendar = () => {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                datesRender: function (info) {
                    ...
                    loadResourcesAndEvents(info.view.currentStart); // Reload resources and events based on the new date
                    var now = new Date();
        ...
        loadResourcesAndEvents(new Date());
        renderCalendar();
    };
