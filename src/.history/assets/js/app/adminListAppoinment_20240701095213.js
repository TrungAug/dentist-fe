            ...
            switch (statusUpdate.status.toLowerCase()) {
                ...
                case 'hoàn thành':
                    Swal.fire({
                        ...
                        if (rs.isConfirmed) {
                            // var isDeleted = false
                            // var currentCondition = "set giá trị"
                            // var reExamination = "set giá trị"
                            // $scope.updateAppoinmentToDB(appointment, statusId, isDeleted, currentCondition, reExamination)
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" placeholder="Mô tả bệnh lý khám được" id="floatingTextarea2Address"
                                                style="height: 100px"></textarea>
                                            <label for="floatingTextarea2Address">Kết quả khám</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                    <div class="form-outline mb-3">
                                            <label class="form-label" for="manageReExamination">Tên
                                                Bác sĩ</label>
                                            <input type="text" id="manageReExamination"class="form-control" placeholder="Hẹn tái khám">
                                        <div>                              
                                    </div>
                                </div>                              
                                `,
