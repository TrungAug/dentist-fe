...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initializeCalendarAppointment = () => {
        // $('#calendar-book-appointment').fullCalendar({
        ...
        //             },
        //             icon: 'fa fa-star' // Thay đổi icon theo ý muốn, ví dụ sử dụng Font Awesome
        //         }
        //     },
        //     views: {
        //         multiColAgendaDay: {
        ...
        $('#calendar-book-appointment').fullCalendar({
            ...
            headerToolbar: {
                left: 'prev,next today',
                center: 'title',
                right: 'multiColAgendaDay,multiColAgendaWeek customButton' // Thêm customButton vào phía right
            },
            customButtons: {
                customButton: {
                    text: 'Custom',
            ...
            views: {
                multiColAgendaDay: {
                    ...
                    duration: { days: 1 },
                    numColumns: 3,
                    columnHeaderFormat: { weekday: 'short' } // Format của header của mỗi cột
                },
                multiColAgendaWeek: {
                    type: 'multiColAgenda',
                    duration: { weeks: 1 },
            ...
            allDaySlot: false,
            initialView: 'multiColAgendaDay', // initialView thay cho defaultView
            initialDate: '2015-02-12', // initialDate thay cho defaultDate
            editable: true,
            events: [
                {
                    title: 'Meeting 1',
