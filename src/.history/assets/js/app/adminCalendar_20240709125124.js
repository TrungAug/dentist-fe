...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.saveAppointment = () => {
        ...
        // console.log("$scope.appointmentPatientRecordRequest", $scope.appointmentPatientRecordRequest);
        // console.log("$scope.appointmentRequest", $scope.appointmentRequest);
        // console.log("$scope.doctorUnavailabilityRequest", $scope.doctorUnavailabilityRequest);
        // console.log("$scope.appointmentServiceRequest", $scope.appointmentServiceRequest);
