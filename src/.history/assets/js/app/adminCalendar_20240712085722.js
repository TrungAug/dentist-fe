        ...
        const renderCalendar = () => {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                select: function (arg) {
                    ...
                    var specificEvent = calendar.getEvents().find(event => event.id === "");
                    if (specificEvent) {
                        if (arg.start < specificEvent.start || arg.end > specificEvent.end) {
                            Swal.fire({
                                position: "top-end",
                                icon: "warning",
                                title: "Thời gian chọn không hợp lệ với lịch làm việc!",
                                showConfirmButton: false,
                                timer: 1500
                            });
                            calendar.unselect();
