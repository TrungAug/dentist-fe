app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.updateAppoinmentToDB = (appointment, statusId,isDeleted,currentCondition,reExamination) => {
        var dataAppointmentRequestJSON = angular.toJson($scope.getDataAppointmentRequest(appointment, statusId))
        var dataDoctorUnavailabilityRequest = angular.toJson($scope.getDataDoctorUnavailabilityRequest(appointment))
        var dataAppointmentPatientRecordRequest = angular.toJson($scope.getDataAppointmentPatientRecordRequest(appointment))
