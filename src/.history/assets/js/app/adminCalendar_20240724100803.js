            ...
            $http.get(url + '/doctorUnavailability').then((response) => {
                ...
                if ($scope.isReExaminationFilter) {
                    ...
                    filteredData.sort((a, b) => {
                        ...
                        let dateA = TimezoneService.convertToTimezone(moment(dateStrA,"DD/MM/YYYY").format("YYYY-MM-DD"), defaultTimezone)
                        let dateB=TimezoneService.convertToTimezone(moment(dateStrB,"DD/MM/YYYY").format("YYYY-MM-DD"), defaultTimezone)
