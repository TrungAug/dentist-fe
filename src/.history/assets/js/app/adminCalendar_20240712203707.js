...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initDataRequest = (isUpdate) => {
        ...
        console.log("$scope.appointmentRequest",$scope.appointmentRequest);
    ...
    $scope.saveAppointment = async () => {
        ...
        if (valid) {
            try {
                ...
                var dataArrayDUReq = $scope.generateDoctorUnavailabilityRequest($scope.selectedTimeOfShift, appointmentId,false)
                var dataArrayServiceReq = $scope.generateAppointmentServiceRequest($scope.selectedServices, appointmentId,false)
