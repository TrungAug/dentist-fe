            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                datesRender: function (info) {
                   // $scope.fullCalendarDate = info.view.currentStart;
                    ...
                    var el=calendarEl.querySelectorAll('td.fc-widget-content')
                    console.log("el ll",el.getAttribute('resource.id'));
                ...
                resourceRender: function(arg) {
                    console.log("Resource arg",arg);
                    console.log('Resource ID:', arg.resource.id);
                    console.log('Resource Title:', arg.resource.title);
                    // If you have the resource hours stored somewhere, you can access it here.
                }
            });
