app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location, $timeout, $window, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.crudDoctorSchedule = () => {
        ...
        $scope.changeDoctorSchedule = () => {
            ...
            // $scope.formDoctorSchedule.date = moment(dates, 'DD/MM/YYYY').toDate()
            // $scope.formDoctorSchedule.shiftId = shiftIds
            ...
            try {
                ...
                if (isDoctorUnavailable) {
                    ...
                    $timeout(() => {                      
                        ...
                        console.log("$scope.formDoctorSchedule aaa",$scope.formDoctorSchedule);
