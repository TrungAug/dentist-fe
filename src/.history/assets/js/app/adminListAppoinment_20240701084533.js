app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.getDataAppointmentRequest = (appoinment, statusId) => {
        ...
        //     appointmentStatus: appointment.appointment.appointmentStatus.statusId,
        //     appointmentType: appoinment.appointmentType.appointment_TypeId,
        //     doctorId: appoinment.doctor.doctorId,
        //     dentalStaffId: appoinment.dentalStaff.dentalStaffId,
        //     appointmentDate: appoinment.appointmentDate,
        //     note: appoinment.note,
        //     createAt: appoinment.createAt,
        //     isDeleted: false,
        //     appointmentPatientRecord: appoinment.appointmentPatientRecord.appointmentPatientRecordId
        // }
    ...
    $scope.getDataDoctorUnavailabilityRequest = (appoinment) => {
        $scope.formDoctorUnavailabilityRequest = {
            ...
            timeOfShiftId: appoinment.timeOfShift.timeOfShiftId,
            appointmentId: appoinment.appointment.appointmentId,
    ...
    $scope.getDataAppointmentPatientRecordRequest = (appoinment) => {
        $scope.formAppointmentPatientRecordRequest = {
            patientId: appoinment.patient.patientId,
            createAt: appoinment.createAt,
