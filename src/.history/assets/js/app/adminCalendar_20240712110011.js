...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initDataRequest = (originalAppointment, originalAPR) => {
       console.log("originalAppointment dm",originalAppointment);
       console.log("originalAPR dm",originalAPR);
        var appLength = originalAppointment.length
        var aprLength= originalAPR.length
        console.log("originalAppointment from init", appLength);
        console.log("originalAPR  from init", aprLength);
