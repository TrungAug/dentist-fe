...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initDataRequest = (originalAppointment, originalAPR) => {
        ...
        originalAPR=[originalAPR]
        //     console.log("originalAppointment cc",originalAppointment);
        //    console.log("originalAPR cc",originalAPR);
        //    console.log("originalAppointment dm",typeof originalAppointment);
        //    console.log("originalAPR dm",typeof originalAPR);
        console.log("originalAppointment []", originalAppointment == []);
        console.log("originalAPR []",originalAPR==[]);
        console.log("originalAppointment null", originalAppointment == null);
        console.log("originalAPR null",originalAPR==null);
