app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.getDataAppointmentRequest = (appointment, statusId) => {
        ...
        $scope.formAppointmentRequest = {
            ...
            doctorId: appointment.appointment.doctor == null ? null : appointment.appointment.doctor.doctorId,
            dentalStaffId: appointment.appointment.dentalStaff == null ? null : appointment.appointment.dentalStaff.dentalStaffId,
    ...
    $scope.getDataDoctorUnavailabilityRequest = (appointment) => {
        $scope.formDoctorUnavailabilityRequest = {
            ...
            timeOfShiftId: appointment.appointment.timeOfShift.timeOfShiftId,
            appointmentId: appointment.appointment.appointment.appointmentId,
