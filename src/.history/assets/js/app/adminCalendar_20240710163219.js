            ...
            $scope.processDoctorUnavailability().then(dataDu => {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    select: function (arg) {
                        ...
                        var fortmatNow = moment(now).format("YYYY-MM-DDTHH:mm:ss")
                        console.log("fortmatNow", fortmatNow);
                        console.log("fortmatNow<argStr", arg.startStr > fortmatNow);
                        if (arg.startStr < fortmatNow) {
                            alert("Không được chọn")
                            calendar.unselect()
                        }
                        // console.log("arg",arg.startStr);
                        // console.log("now",now);
                        // now.setMinutes(now.getMinutes() - 10)
                        // if (now < arg.start || arg.start.getHours() < 7 || arg.start.getHours() > 21) {
                        //     alert("Không được chọn")
                        //     calendar.unselect()
                        // }
                    },
                    ...
                    datesRender: function (info) {
                        ...
                        tdElements.forEach(td => {
                            ...
                            if (tdDate < now || tdDate.getHours() < 7 || tdDate.getHours() > 21) {
