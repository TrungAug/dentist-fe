app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.updateStatus = (appoinment, statusId) => {
        ...
        if(statusUpdate.status.toLowerCase()==='đã hủy'){

        }else if(statusUpdate.status.toLowerCase()==='không đến'){

        }else if(statusUpdate.status.toLowerCase()==='hoãn'){

        }else if(statusUpdate.status.toLowerCase()==='đang diễn ra'){

        }else if(statusUpdate.status.toLowerCase()==='đã xác nhận'){

        }else if(statusUpdate.status.toLowerCase()==='đã đặt'){

        }else if(statusUpdate.status.toLowerCase()==='hoàn thành'){
