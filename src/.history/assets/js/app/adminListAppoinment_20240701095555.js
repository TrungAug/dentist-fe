                                ...
                                <div class="row d-flex flex-column flex-wrap">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" placeholder="Mô tả bệnh lý khám được" id="currentCondition"
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-outline mb-3">
                                            <label class="form-label" for="reExamination">Tái khám</label>
                                            <input type="text" id="reExamination"class="form-control" placeholder="Hẹn tái khám">
                                        <div>                              
                                    </div>
                                </div>                              
                                `,
