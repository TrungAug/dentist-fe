        ...
        const renderCalendar = () => {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                resourceRender: function (arg) {
                    ...
                    $scope.getDoctorScheduleShiftsExcludingDeleted($scope.fullCalendarDate, arg.resource.id).then(result => {
                        ...
                        result.forEach(item => {                           
                            ...
                            tdElements.forEach(td => {
                                ...
                                //console.log("tdDate",moment(tdDate).format("HH:mm:ss"));
                                // console.log("shift.beginTime",shift.beginTime);
                                // console.log("tdTime",tdTime);
                                // console.log("tdTime===shift.beginTime",tdTime===shift.beginTime);
                                // if(shift.beginTime<=tdTime<=shift.endTime){
                    ...
                    // var index = resourcesIds.indexOf(arg.resource.id)
                    // if (index === -1) {
                    //     resourcesIds.push()
                    // }
