app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location, $timeout, $window, processSelect2Service, TimezoneService, $route) {
        ...
        $('.drgpicker').daterangepicker(
            {
                ...
                //         $('.drgpicker').data('daterangepicker').setStartDate(start);
                //         $('.drgpicker').data('daterangepicker').setEndDate(start);
                //     }
                // }
            }
        );
        $('.drgpicker').on('hide.daterangepicker', function(ev, picker) {
            ...
            if (picker.startDate.format('DD/MM/YYYY') === picker.endDate.format('DD/MM/YYYY')) {
                // Cập nhật lại picker để chỉ chọn một ngày
    ...
    $scope.crudDoctorSchedule = () => {
        ...
        $scope.changeDoctorSchedule = () => {
            ...
            console.log("$scope.formDoctorSchedule",$scope.formDoctorSchedule);
        }
