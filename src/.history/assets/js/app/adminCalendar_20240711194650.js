    ...
    $scope.initializeCalendarAppointment = () => {
        ...
        const loadDoctorUnavailability = () => {
            ...
            $scope.getAllDoctorScheduleExceptDeleted().then(dataDs => {
                dataDs.forEach(ds => {
                    console.log("ds.shift.endTime",ds.shift.endTime);
                    let event = {
                        id: "",
        ...
        const renderCalendar = () => {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                select: function (arg) {
                    ...
                    if (startDate < now || startDate.getHours() < 7 || startDate.getHours() > 22) {
                        Swal.fire({
                            position: "top-end",
                            icon: "warning",
                ...
                datesRender: function (info) {
                    ...
                    tdElements.forEach(td => {
                        ...
                        var isPast = tdDate < now || tdDate.getHours() < 7 || tdDate.getHours() > 22;
                        if (isPast) {
                ...
                resourceRender: function (arg) {
                    //console.log("rg.resource.id",arg.resource.id);
