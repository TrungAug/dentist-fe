app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route, convertMoneyService) {
    ...
    $scope.getServiceByDentalIssues = (dentalIssuesIds) => {
        ...
        $http.get(url + '/service-by-dental-issues', { params: params }).then(response => {
            ...
            console.log(" $scope.listServiceByDentalIssuesDB", $scope.listServiceByDentalIssuesDB);
        })
    }
    ...
    $scope.getListDoctorUnavailabilityAllDoctor = () => {
        $scope.processDoctorUnavailabilityAllDoctor().then(result => {
            ...
            console.log("$scope.listAppointmentDBFromDu", $scope.listAppointmentDBFromDu);
    ...
    $scope.getDetailsAppointment = (appointmentId) => {
        console.log(" $scope.listDoctorUnavailabilityAllDoctorDB kaka", $scope.listDoctorUnavailabilityAllDoctorDB.filter(du=>du.appointment.appointmentId === appointmentId));

        return $scope.listDoctorUnavailabilityAllDoctorDB.filter(du=>du.appointment.appointmentId === appointmentId)
    };
