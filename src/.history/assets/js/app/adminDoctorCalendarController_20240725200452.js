    ...
    $scope.initializeUIComponentsModal = () => {
        ...
        $('#dental-issues-doctorUp').on('change', function () {
            $timeout(function () {
               ...
               // $scope.getServiceByDentalIssuesUp(selecteDentalIssues)
                $scope.getTreatmentByDentalIssues(selecteDentalIssues)
        ...
        $('#treatment-doctorUp').on('change', function () {
            $timeout(function () {
                ...
                selecteTreatments = processSelect2Service.processSelect2Data(selectedVals)
                $scope.getServiceByTreatment(selecteTreatments)
            });
        });
