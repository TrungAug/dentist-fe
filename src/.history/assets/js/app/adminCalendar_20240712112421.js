...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initDataRequest = (originalAppointment, originalAPR) => {
        ...
        console.log("originalAppointment",originalAppointment.appointmentId?originalAppointment.appointmentId:-1);
    ...
    $scope.initializeCalendarAppointment = () => {
        ...
        const loadDoctorUnavailability = () => {
            ...
            $scope.processDoctorUnavailability().then(dataDu => {
                dataDu.forEach(du => {
                    let color = $scope.getColorForStatusId(du.appointment?du.appointment.appointmentStatus.status:"đã xác nhận");
                    let event = {
