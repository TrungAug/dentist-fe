            ...
            $scope.processDoctorUnavailability().then(dataDu => {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    selectAllow: function (selectInfo) {
                        ...
                        return selectInfo.start >= currentTime;
                    },
                    select: function (arg) {
                ...
                var currentTime = new Date();
                var slots = calendarEl.getElementsByClassName('fc-timegrid-slot');
                for (var i = 0; i < slots.length; i++) {
                    var slotTime = new Date(slots[i].getAttribute('data-time'));
                    if (slotTime < currentTime) {
                        slots[i].classList.add('fc-timegrid-slot-limited');
                    }
                }
