...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initializeCalendarAppointment = () => {
        var fulCalendarDate=new Date();

        function initializeFullCalendar(fulCalendarDate,resources,dataDu){
            var calendarEl = document.getElementById('calendar-book-appointment')
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    datesRender: function (info) {
                        ...
                        fulCalendarDate = info.view.currentStart;
                        console.log("FullCalendar Date:", fulCalendarDate);
                        var now = new Date();
        ...
        $scope.processDSWithAppointmentStatus(fulCalendarDate).then(result => {
            var resources = []
