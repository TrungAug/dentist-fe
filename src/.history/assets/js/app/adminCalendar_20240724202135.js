    ...
    $scope.exportPDF = (contentId, nameDocument) => {
        $scope.$evalAsync(() => {
            document.fonts.ready.then(() => {
                ...
                // Array to hold page definitions
                const pages = [];
                ...
                tempElement.style.left = '0px';
                tempElement.style.top = '0px';
                tempElement.style.width = '1000px'; // Example width
                tempElement.style.visibility = 'visible';
                tempElement.style.background = 'white';
                document.body.appendChild(tempElement);
                ...
                // Function to capture content and return a promise
                ...
                // Function to add page to PDF document
                ...
                function captureAndAddPages() {
                    let promises = [];
                    let pageHeight = pdfContent.clientHeight; // Height of the content element
                    let tempElementHeight = tempElement.offsetHeight; // Height of the temporary element
    
                    // Calculate number of pages needed
                    let numPages = Math.ceil(tempElementHeight / pageHeight);
    
                    // Capture each page
                    for (let i = 0; i < numPages; i++) {
                        tempElement.style.top = `-${i * pageHeight}px`;
                    ...
                    // After all pages are captured, generate PDF
