...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.onChangeTimeOfShiftId = (tos) => {
        if (tos.checked) {
    ...
    $scope.generateAppointmentServiceRequest=(selectedServices)=>{

    }

    $scope.generateDoctorUnavailabilityRequest = (dselectedTimeOfShift) => {
        var scheduleArray = [];
    ...
    $scope.initializeUIComponents = () => {
        ...
        $('#dental-issues').on('change', function () {
            $timeout(function () {
                ...
                console.log("$scope.listDentalIssueDB", $scope.listDentalIssueDB)
