app.controller('AdminDoctorCalendarController', function ($scope, $http, $rootScope, $location, $timeout, $window, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.isDisabledStatus = (tableStatus) => {
        console.log("$scope.validStatus",$scope.validStatus);
    ...
    $scope.initializeUIComponentsModal = () => {
        ...
        //         $scope.formDoctorUp.patientId = processSelect2Service.processSelect2Data(selectedVal)[0]
        //     });
        // });
        // $('#appointmentTypeUp').on('change', function () {
        //     $timeout(function () {
        //         let selectedVal = $('#appointmentTypeUp').val()
        //         $scope.formDoctorUp.appointmentTypeId = processSelect2Service.processSelect2Data(selectedVal)[0]
        //     });
        // });
