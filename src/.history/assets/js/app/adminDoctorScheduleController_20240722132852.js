app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location, $timeout, $window, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.countShiftByDoctor = (listDSByTimeRangesDB) => {
        // let uniqueDoctors = {};
        // for (let key in listDSByTimeRangesDB) {
        //     let filterData = listDSByTimeRangesDB[key];
        //     filterData.forEach(ds => {
        //         let doctorId = ds.doctor.doctorId;
        ...
        //         uniqueDoctors[doctorId].schedules.push(ds);
        //     });
        // }

        // let uniqueDoctorsArray = Object.values(uniqueDoctors);
        console.log("listDSByTimeRangesDB",listDSByTimeRangesDB);
