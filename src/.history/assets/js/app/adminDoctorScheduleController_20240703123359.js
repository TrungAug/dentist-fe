app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location, $timeout, $window, processSelect2Service) {
    ...
    $scope.initializeFullCalendar = () => {
        ...
        $scope.processDoctorUnavailabilityByDoctor().then(result => {
    ...
    $scope.getListDoctorScheduleByDoctor = () => {
        $scope.processDoctorScheduleByDoctor().then(result => {
    ...
    $scope.processDoctorUnavailabilityByDoctor = () => {
        return new Promise((resolve, reject) => {
    ...
    $scope.processDoctorScheduleByDoctor = () => {
        return new Promise((resolve, reject) => {
    ...
    $scope.crudDoctorSchedule = () => {
        ...
        $scope.changeDoctorSchedule=()=>{
            var chageDoctorScheduleResquestJSON=angular.copy($scope.formDoctorSchedule)

            console.log("chageDoctorScheduleResquestJSON",chageDoctorScheduleResquestJSON);
        }

        $scope.changeSchedule=(doctorSchedule)=>{
            $scope.formDoctorSchedule=angular.copy(doctorSchedule)
            $scope.formDoctorSchedule.date=moment($scope.formDoctorSchedule.date).format('DD/MM/YYYY')
            $scope.formDoctorSchedule.shiftId=$scope.formDoctorSchedule.shift.shiftId
