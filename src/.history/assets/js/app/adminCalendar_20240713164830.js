...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.updateAppointment = () => {
        ...
        console.log("reqAppData", reqAppData.updateArr);
        console.log("reqDuData", reqDuData.updateArr);
        console.log("reqAsData", reqAsData.updateArr );
        ...
        const handleApiRequest = (deleteUrl, postUrl, putUrl, data, idKey) => {
            ...
            if (data.updateArr.length !== 0) {
                data.updateArr.forEach(uArr => {
                    uArr[0].forEach(oItem => {
                        var id = oItem[idKey]
                        console.log("oItem[idKey]", oItem[idKey]);
                        uArr[1].forEach(uItem => {
