        ...
        const renderCalendar = () => {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function (arg) {
                    ...
                    $scope.day = $scope.curentDateTreatment.getDate();
                    $scope.day < 10 ? '0' + $scope.day : $scope.day
                    $scope.month = $scope.curentDateTreatment.getMonth() + 1; // Tháng bắt đầu từ 0
                    $scope.month < 10 ? '0' + $scope.month : $scope.month)
                    $scope.year = $scope.curentDateTreatment.getFullYear();

                    console.log("$scope.originalPatient", $scope.originalPatient);
                    $scope.formDoctorUp = {
