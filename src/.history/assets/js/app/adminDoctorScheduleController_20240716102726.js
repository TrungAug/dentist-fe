app.controller('AdminDoctorScheduleController', function ($scope, $http, $rootScope, $location, $timeout, $window, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.getHourWorking=(listDoctorScheduleAllDoctorDB,doctorId) => {
        console.log("listDoctorScheduleAllDoctorDB",listDoctorScheduleAllDoctorDB);
        const currentDate = new Date()
        let filterData = listDoctorScheduleAllDoctorDB.filter(ds => ds.doctor.doctorId === doctorId)
