app.controller('AdminListAppoinment', function ($scope, $http, $rootScope, $location, $timeout, TimezoneService, $route) {
    ...
    $scope.updateAppoinmentToDB = async (appointment, statusId, isDeleted, currentCondition, reExamination) => {
        ...
        // var response = await $http.put(url + '/appointment-patient-record', dataAppointmentPatientRecordRequest)

        // var resp = await $http.put(url + '/appointment', dataAppointmentRequestJSON)

        // var res = await $http.put(url + '/doctorUnavailability', dataDoctorUnavailabilityRequest)
