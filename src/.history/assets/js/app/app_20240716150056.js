...
app
    ...
    .service('BreadcrumbService', function($rootScope, $location) {
        var breadcrumbs = [];
        ...
        var updateBreadcrumbs = function() {
            ...
            for (i = 0; i < pathElements.length; i++) {
                result.push({ label: pathElements[i], url: breadcrumbPath(i) });
            }
            breadcrumbs = result;
            console.log("breadcrumbs breadcrumbs breadcrumbs",breadcrumbs);
        };
