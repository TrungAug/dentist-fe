...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.getListAppointmentBySatus=(listAppointmentDB,statusId)=>{
        console.log("statusId",statusId);
        console.log("listAppointmentDB",listAppointmentDB);
       // console.log("$scope.listAppointmentDB",$scope.listAppointmentDB);
    //    if($scope.listAppointmentDB.length>0){
    //     return $scope.listAppointmentDB.filter(app=>app.appointmentStatus.appointment_StatusId===statusId).length
    //    }     
    }
