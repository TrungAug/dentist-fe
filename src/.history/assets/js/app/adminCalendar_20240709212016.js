...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initializeCalendarAppointment = () => {
        ...
        let calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            editable: true,
            slotMinTime: '07:00:00', // Giờ bắt đầu của các slot
            slotMaxTime: '21:00:00', // Giờ kết thúc của các slot
            ...
            viewDidMount: function(view) {
                // Loại bỏ các <th> không mong muốn
                var headerCells = calendarEl.querySelectorAll('.fc-widget-header');
                headerCells.forEach(function(cell) {
                    var hour = cell.getAttribute('data-date');
            ...
            events: [
                {
                    id: '1',
                    title: 'Lịch khám bệnh 1',
                    start: '2024-07-09T10:00:00',
                    end: '2024-07-09T12:00:00',
                    resourceId: 'a' // Đối ứng với id của resource
                },
                {
                    id: '2',
                    title: 'Lịch khám bệnh 2',
                    start: '2024-07-09T14:00:00',
                    end: '2024-07-09T16:00:00',
                    resourceId: 'b' // Đối ứng với id của resource
                }
            ],
            resources: [
                {
                ...
                },
                {
                    id: 'b',
                    title: 'Bác sĩ B',
                    eventColor: 'green' // Màu sự kiện tương ứng với bác sĩ B
                }
            ]
        });
