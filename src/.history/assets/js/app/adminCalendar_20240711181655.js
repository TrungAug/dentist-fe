        ...
        const loadDoctorUnavailability = () => {
            ...
            $scope.getAllDoctorScheduleExceptDeleted().then(dataDs => {  
               // console.log("doctor-schedule-and-tos",dataDs);        
                dataDs.forEach(ds => {
                    $scope.getTimeOfShiftByShiftId(ds.shift.shiftId).then(dataTos=>{
                        dataTos.forEach(tos =>{
                            console.log("tos aaaa",ds.date.split("T")[0]);
                            // let event = {
                            //     id: "",
                            //     start: ds.date.split("T")[0] + "T" + tos.beginTime,
                            //     end: ds.date.split("T")[0] + "T" + tos.endTime,
