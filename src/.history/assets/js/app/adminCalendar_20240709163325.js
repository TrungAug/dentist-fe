...
app.controller('AdminCalendar', function ($scope, $http, $rootScope, $location, $timeout, processSelect2Service, TimezoneService, $route) {
    ...
    $scope.initializeCalendarAppointment = ()=>{
        $('#calendar-book-appointment').fullCalendar({
			...
			views: {
				multiColAgendaDay: {
					...
					duration: { days: 1 },
					numColumns: 2,
					columnHeaders: ['First Column', 'Second Column','Th Column']
				},
				multiColAgendaWeek: {
					type: 'multiColAgenda',
					duration: { weeks: 1 },
					numColumns: 2,
					columnHeaders: ['First', 'Second','Second']
				}
			},
			allDaySlot: false,
        ...
        //   },
        //   allDaySlot: false,
        //   initialView: 'multiColAgendaDay',
        //   initialDate: '2015-02-12',
        //   editable: true,
        //   resources: [
        //     { id: '0', title: 'First Column' },
        //     { id: '1', title: 'Second Column' }
        //   ],
        //   events: [
        //     {
        //       title: 'Meeting 1',
